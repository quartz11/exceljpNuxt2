  ...
  <div>
    ...
    <div class="container mx-auto">
      ...
      <div class="border shadow-2xl mockup-window bg-violet-600">
        <div class="flex justify-center px-4 py-16 text-xl text-black shadow-2xl bg-white">
          <br />
          ...
          <table class="justify-center w-full table-auto ">
            ...
            <tbody>
              <tr>
                <td class="content-center text-3xl text-center">Privacy Policy</td>
              </tr>
              <br />
              <tr>
                <td class="text-xl text-center">Excellence Inc. Ltd. (hereinafter referred to as the Company) will
    ...
    <div class="flex justify-center mx-auto">
      <div class="justify-center overflow-hidden rounded shadow-2xl bg-slate-50 w-11/12">
        <div class="card-header text-xl" style="background-color:blueviolet; color:white;">&nbsp;&nbsp; Privacy Policy
        </div>
            ...
            <thead>
              <th>
                <p class="text-black text-left	">
                  ...
                  of the business.
                  <br />
                  In addition, the personal information to interoperate with third parties, or, if you want to entrust
                  ...
                  <br />
                  <br />
                  ■ The Company, in person for personal information, it is recognized that has the right to ask for such
                  disclosure, correction, suspension of use and erase, you can set up a personal information
                  consultation, if there these requests, in accordance with laws and regulations promptly we will
                  correspond. <br />
                  <br />
                  ■ The Company will establish a system for implementing the proper handling of personal information to
                  be used on business. <br />
                  <br />
                  ■ The Company, in order to run this Privacy Policy, we have established a personal information
                  protection compliance program, which was run by well-known thorough in the company through training
                  and education, by continuous improvement, always best We will maintain the state.
                </p>
              </th>
            </thead>
          </table>
